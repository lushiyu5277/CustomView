...
public class ColoredTextView extends AppCompatTextView {
    ...
    private static final int CORNER_RADIUS = (int) UIUtil.dpToPixel(4);
    private static final int X_PADDING = (int) UIUtil.dpToPixel(16);
    private static final int Y_PADDING = (int) UIUtil.dpToPixel(8);
